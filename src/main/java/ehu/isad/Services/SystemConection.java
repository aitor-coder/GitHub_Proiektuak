            ...
            try{
                ...
                if (System.getProperty("os.name").toLowerCase().contains("win")) {
                    if(System.getProperty("os.name").toLowerCase().contains("8.1")){
                        ...
                        Runtime.getRuntime().exec(properties.getProperty("pathPlink")+"\\pscp.exe -batch -P 22 -pw dbs dbs@"+properties.getProperty("ip_Addr")+":insert.sql "+properties.getProperty("pathPlink")+"\\");
                    }else {
...
//                    f.delete();
//                    Runtime.getRuntime().exec("del /F "+properties.getProperty("pathToInsertWin"));
                }else {
